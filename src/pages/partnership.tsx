    ...
    <main className="min-h-screen bg-cm-gray py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl p-8 shadow-card">
          <h1 className="text-3xl font-bold text-cm-blue-dark mb-2 text-center">Partnership Enquiry</h1>
          <p className="text-gray-600 text-center mb-8">Partner with us to transform educational infrastructure.</p>
